...
export async function GET(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    let dataQuery = supabase
      .from('participants')
      .select('id, full_name, cedula, phone, store, province, city, invoice_url, prize_type, terms_accepted, terms_accepted_at, data_treatment_accepted, data_treatment_accepted_at, created_at')
